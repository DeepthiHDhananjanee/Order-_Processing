	...
	<div class="nav">
		...
		<div class="nav1">
			<ul>
				...
				<li><a href="product1.php" class="active" style="color:#111;">CD/DVD</a></li>
				<li>|</li>
				<li><a href="software1.php">Software</a></li>
				<li>|</li>
				<li><a href="hardware1.php">Hardware</a></li>
			</ul>
				<?php echo "<a href='cart.php?id=".$id."&action=view'><button class='btn btn-inverse' style='right:1%; position:fixed; top:15%;'><i class='icon-shopping-cart icon-white'></i> View Cart</button></a>" ?>
		</div>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php 
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='CD/DVD' ORDER BY product_id DESC") or die (mysqli_error());

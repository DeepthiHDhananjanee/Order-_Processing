...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			...
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Search Purchases here..." id="filter"></label>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM purchase LEFT JOIN student_details ON student_details.student_id = purchase.student_id") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query))
						{
						$id = $fetch['purchase_id'];
						$amnt = $fetch['amount'];

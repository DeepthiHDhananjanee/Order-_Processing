...
<body>
	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="cd/dvd"></td>
							</tr>
						</table>
					</center>
				</div>
		...
		<?php
			if (isset($_POST['add']))
				...
				exit(header ("location:admin_cddvd.php"));
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>CD/DVD</h2></center></div>
			<br />
 ...
 $row = mysqli_fetch_array($result);
  ...
  header("Location:admin_cddvd.php");

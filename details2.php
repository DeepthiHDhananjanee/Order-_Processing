		...
		<img src="img/347.png">
			...
			<?php
				//$id = (int) $_SESSION['id'];
					...
					//$query = mysql_query ("SELECT * FROM student_details WHERE student_id = '$id' ") or die (mysql_error());
...
<div id="container">
	<div class="nav">	
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<input type="hidden" value="<?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['lastname'];?>" name="student_details">
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of 347 Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">347 Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
						...
						<li>All prices quoted are in Sri Lanka Rupees. Price and availability information is subject to change without notice.</li>
						<li>Mode of payment are as follows:students with paypal account can pay through paypal otherwise Cash on Delivery(COD).</li>
						<li>Upon receiving your product we will charge for delivering for only 250 Sri Lanka Rupees, depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">347 Inc. 2015</p>
		</div>
	</div>
</body>
</html>